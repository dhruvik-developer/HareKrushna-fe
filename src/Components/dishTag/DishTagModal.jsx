...
export default function DishTagModal({
  ...
  const [settings, setSettings] = useState({
    ...
    borderColor: "#e5e7eb",
    showCaterer: false,
    catererName: catererNameProfile || "HareKrushna Catering",
    showSession: false,
  ...
  useEffect(() => {
    if (catererNameProfile && settings.catererName === "HareKrushna Catering") {
      ...
      <div className="hidden print:block absolute -left-2499.75 top-0 print:static print:auto w-full">
        <PrintLayout
          dishes={allDishes.map((name, index) => ({
            ...
            caterer: settings.catererName || "HareKrushna Catering",
          }))}
          config={{
