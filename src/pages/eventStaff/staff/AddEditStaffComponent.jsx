                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        step="0.01"
                        min="0"
                        className={`w-full pl-14 pr-4 py-3 rounded-xl border ${errors.per_day_rate ? "border-red-500 bg-red-50" : "border-gray-200 bg-gray-50"} focus:bg-white focus:ring-2 focus:ring-[#845cbd]/20 focus:border-[#845cbd] transition-all outline-none`}
                      />
                    </div>
                    {errors.per_day_rate ? (
                      <p className="text-red-500 text-xs font-medium pl-1">
