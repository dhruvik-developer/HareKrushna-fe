        ...
        <div className="max-w-5xl mx-auto mb-6 flex justify-between items-center bg-white p-4 rounded-xl shadow-sm border border-slate-200 no-print">
          ...
          <div className="flex gap-4">
            {!viewingHistoryBill && (
              ...
              >
                <FiSave className="mr-2" /> {isSavingBill ? "Saving..." : "Save Bill"}
              </button>
            )}
            <button
              onClick={downloadPdf}
            ...
            <div className="flex justify-between items-stretch mb-6 mt-1 min-h-[130px]">
              ...
              <div className="flex-1 bg-slate-50/50 rounded-2xl border border-slate-200/60 p-5 flex flex-col justify-between shadow-sm relative overflow-hidden">
                ...
                <div className="flex justify-between items-center mb-4 transition-all">
                  <div className="bg-indigo-700 text-white px-4 py-1.5 rounded-md shadow-md">
                    <h2 className="text-[10px] font-black tracking-[0.25em] uppercase m-0 leading-none">TAX INVOICE</h2>
                  </div>
                  <div className="text-[10px] font-black text-slate-300 uppercase tracking-widest">ORIGINAL</div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-y-3 gap-x-4">
                  ...
                  <div>
                    <p className="text-[9px] text-slate-400 font-bold uppercase tracking-widest mb-0.5">Order No.</p>
                    <p className="text-sm font-black text-slate-700 uppercase">{pData.orderNo || "N/A"}</p>
                  </div>
                  <div>
                    ...
                    {filteredBills.map(bill => (
                      <tr key={bill.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="p-4 text-center">
                          <button
                            className="bg-purple-50 text-purple-700 border border-purple-200 hover:bg-purple-100 px-4 py-1.5 text-xs font-semibold rounded transition inline-flex items-center shadow-sm whitespace-nowrap"
                            onClick={() => {
